...
class Resume(db.Model):
    ...
    Stores the original filename, the full extracted text, and the structured data generated by the NLP pipeline.
    """
    ...
    def __repr__(self)->str:
        ...
        #Check for candidate existence for robustness
        if self.candidate:
