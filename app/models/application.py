...
class Application(db.Model):
    ...
    This is a critical table that stores the application status and the results
    of the ranking model (feature scores and the final predicted score).
    """
    ...
    def __init__(self, job_id, candidate_id, resume_id, feature_scores=None, final_score=None, **kwargs):
        ...
        This provides a clear and explicit way to create new records.
        """
        super().__init__(**kwargs)  # Ensures proper SQLAlchemy initialization
