...
class NLPService:
    ...
    This service is responsible for sectionizing text and extracting structured
    entities like skills, experience, and education level.
    """
    ...
    def __init__(self):
        ...
        # Use the imported skill list to build a powerful PhraseMatcher for efficient skill detection.
    ...
    def _extract_skills(self, doc: spacy.tokens.Doc) -> list:
        ...
        # Use a set to automatically handle duplicate skill mentions, then sort for consistent output.
    ...
    def _extract_experience_years(text: str) -> int:
        ...
        This heuristic handles formats like "May 2020 - Present" or "2018-2020".
        """
    ...
    def process_document(self, text: str) -> dict:
        ...
        It orchestrates sectionizing and entity extraction.
        """
        if not text:
            return {}
