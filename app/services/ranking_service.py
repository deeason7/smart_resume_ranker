...
class RankingService:
    ...
    It first generates a feature vector based on semantic similarities between
    document sections. It then uses a trained machine learning model to predict
    a final score based on these features. If no ML model is trained, it falls
    back to a reliable heuristic formula.
    """
    ...
    def _load_latest_model(self):
        ...
        This method is called only once when first needed and runs within the app context.
        """
    ...
    def predict_score(self, features: dict) -> float:
        ...
        """
        # Trigger the lazy loading of the trained ML model if it hasn't been attempted yet.
