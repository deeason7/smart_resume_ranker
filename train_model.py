...
with app.app_context():
    ...
    # --- FIX: Split data into training and a final holdout test set FIRST ---
    ...
    # 4. Define Hyperparameter Grid for GridSearchCV
    param_grid = {
    ...
    # 6. Save the Best Model (which was trained on the full training set by GridSearchCV)
